...
enum class KairosErrorCode(
    ...
    CONTEXT_SOURCE_ALREADY_LINKED(HttpStatus.CONFLICT, "CONTEXTSOURCE_001", "Context source already linked to project"),
    CONTEXT_SOURCE_NOT_FOUND(HttpStatus.NOT_FOUND, "CONTEXTSOURCE_002", "Context source not found"),
    CONTEXT_SOURCE_INVALID_PAYLOAD(HttpStatus.BAD_REQUEST, "CONTEXTSOURCE_003", "Invalid context source payload"),
    ...
    AI_MODEL_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "AI_007", "AI model is not supported"),
